...
export const projects = [
  { img: project1, category: 'residential' as const, name: 'Riverside Tower', location: 'Oslo, Norveç', year: '2024', area: '28,000 m²' },
  { img: project2, category: 'residential' as const, name: 'Greenfield Villa', location: 'Barselona, İspaniya', year: '2024', area: '1,200 m²' },
  { img: project3, category: 'nonResidential' as const, name: 'Metro Business Hub', location: 'Dubay, BƏƏ', year: '2025', area: '45,000 m²' },
  { img: project4, category: 'nonResidential' as const, name: 'Lakeside Cultural Center', location: 'Amsterdam, Niderland', year: '2025', area: '18,000 m²' },
  { img: project5, category: 'industrial' as const, name: 'Northgate Industrial Park', location: 'Hamburg, Almaniya', year: '2025', area: '65,000 m²' },
  { img: project6, category: 'urban' as const, name: 'Horizon Urban District', location: 'Sinqapur', year: '2025', area: '120 ha' },
];
  ...
  return (
    <section className="py-24 lg:py-32">
      <div className="container mx-auto px-6 lg:px-12">
        <ScrollReveal>
          <h2 className="font-heading text-3xl md:text-5xl text-center mb-12">{t.featuredProjects.title}</h2>
        </ScrollReveal>
        ...
        <ScrollReveal delay={200}>
          <div className="text-center mt-12">
            <Link to="/layiheler" className="border border-charcoal text-charcoal px-8 py-3 text-sm uppercase tracking-wide hover:bg-charcoal hover:text-offwhite transition-colors active:scale-[0.97]">
