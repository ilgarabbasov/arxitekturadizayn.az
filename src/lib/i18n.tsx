...
const translations = {
  ...
  ru: {
    ...
    aboutPreview: {
      ...
      awards: 'наград',
      description: 'Компания Архитектура & Дизайн ООО основана в 2025 году с целью создания новых стандартов в сфере архитектуры и дизайна в Азербайджане.',
      link: 'Подробнее',
    },
    services: {
      title: 'Услуги',
    ...
    about: {
      ...
      story: 'Компания Архитектура & Дизайн ООО была основана в 2025 году под руководством Джабара Хашимова с целью создания новых стандартов в архитектуре и дизайне в Азербайджане.',
      team: 'Наша команда',
